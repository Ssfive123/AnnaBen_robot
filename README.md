...
##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+𝖢ᴏʙʏ ғɪʟᴛᴇʀ ʙᴏᴛ!;created+by+𝖢ᴏʙʏ+ғɪʟᴛᴇʀ+ʙᴏᴛ!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
